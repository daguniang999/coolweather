package com.example.chenx.coolweather.service;
...
public class AutoUptateService extends Service {
    public AutoUptateService() {
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent i = new Intent(this, AutoUptateService.class);
            ...
            HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    if (weather != null && "ok".equals(weather.status)) {
                        SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(AutoUptateService.this).edit();
